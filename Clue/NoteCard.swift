...
class NoteCard: NSObject {
    ...
    {
        if(selected != nil && event.characters?.trimmingCharacters(in: CharacterSet.alphanumerics.inverted.subtracting(CharacterSet.punctuationCharacters)) != "") // is valid key
        {
